...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var repository: AsempvRepository

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        repository = AsempvRepository.getInstance(this)
        ...
        Log.d("MainActivity", "User is logged in, setting up main activity")
        setupMainActivity()
    }
